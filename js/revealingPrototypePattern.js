...
var source = new calzNS.RedditPhoto();
var photo = source.getPhoto();

var calz = calz || {};

calz.RedditPhoto = function () {
...
calz.RedditPhoto.prototype = function () {
    var getPhoto = function () {
            ...
            req.onload = function () {
                if (req.readyState === 4) {
                    if (req.status === 200) {
                        this.photo = getPost.call(this, JSON.parse(this.responseText));
                    } else {
                        return this.photo;
                    }
                }
